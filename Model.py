# Jose Segovia-Martin
# Complex Systems Insitute of Paris ISCPIF.
# Centre national de la recherche scientifique. CNRS.
# School of Collective Intelligence (SCI-UM6P).
...
# the model we implement here idealises ideologies as fixed and as competing with each
# other for supporters both within and across borders. We also assume constant and homogeneous mixed populations with
# no spatial or social structure. Agents in our model can only support one ideology (party or political tendency) at any given
# moment in time.
...
class VBC:
    def __init__(self, mu1, mu2, mu3, mu4, muB, muC, muD, muE, k1, k2, k3, k4,
        ...
        self.k4 = k4
        #the probability of B convincing another agent per contact. (between 0.0-1.0)
        self.p1 = p1
        #the probability of C convincing another agent per contact. (between 0.0-1.0)
        self.p2 = p2
        #the probability of D convincing another agent per contact. (between 0.0-1.0)
        self.p3 = p3
        #the probability of E convincing another agent per contact. (between 0.0-1.0)
        self.p4 = p4
...
model = VBC(mu1=0.016, mu2=0.016, mu3=0.016, mu4=0.016,
            ...
            gamma1= 0.01, gamma2= 0.01,gamma3=0.01, gamma4=0.01,
            phi1= 0.01, phi2= 0.03, phi3=0.0267, phi4=0.01)
